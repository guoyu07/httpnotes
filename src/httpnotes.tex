...
{\noindent\Huge\bfseries Notes Collection of \\[0.5\baselineskip] HTTP}\\[2\baselineskip] % Title
{\large \textit{HTTP}}\\[4\baselineskip] % Tagline or further description
